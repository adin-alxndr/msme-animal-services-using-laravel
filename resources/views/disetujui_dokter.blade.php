...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Disetujui /</span> Reservasi Dokter</h4>
    <a href="{{ route('riwayat_dokter') }}" class="btn btn-outline-dark text-black m-3">Riwayat</a>

    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                <h5 class="card-header">List Reservasi Dokter</h5>
                            ...
                            <tr>
                                ...
                                <td>
                                  <div class="d-flex justify-content-center">
                                    <form method="POST" action="{{ route('dokter.selesai', ['id' => $dokter->id_cek]) }}" onsubmit="return confirm('Are you sure you want to update the status?')">
                                        @csrf
                                        @method('PATCH')
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <form method="POST" action="{{ route('dokter.batalkan.disetujui', ['id' => $dokter->id_cek]) }}" onsubmit="return confirm('Are you sure you want to update the status?')">
                                                @csrf
                                                @method('PATCH')
