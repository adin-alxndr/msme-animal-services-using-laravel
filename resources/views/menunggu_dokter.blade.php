...
@section('menunggudokter', 'active')

@section('content')

<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Menunggu /</span> Reservasi Dokter</h4>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="POST" action="{{ route('dokter.disetujui', ['id' => $dokter->id_cek]) }}" onsubmit="return confirm('Are you sure you want to update the status?')">
                                        @csrf
                                        @method('PATCH')
                                    ...
                                    <form method="POST" action="{{ route('dokter.batalkan.menunggu', ['id' => $dokter->id_cek]) }}" onsubmit="return confirm('Are you sure you want to update the status?')">
                                        @csrf
                                        @method('PATCH')
